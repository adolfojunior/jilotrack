...
@Aspect
public class DataSourceAspect extends TrackAspect {

	@Before("trackPointcut() && dataSourcePointcut()")
	public void beforeTrackAndPointcut(JoinPoint joinPoint) throws Throwable {
		beforeTrack(joinPoint);
//		Object object = joinPoint.getThis();
//		LogUtil.log("### DataSourceAspect: ", object);
	}

	@AfterReturning("trackPointcut() && dataSourcePointcut()")
	public void afterTrackReturningAPI(JoinPoint joinPoint) throws Throwable {
		afterTrackReturning(joinPoint);
	}

	@AfterThrowing(pointcut = "trackPointcut() && dataSourcePointcut()", throwing = "e")
